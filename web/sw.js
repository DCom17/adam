 ...
 */
const CACHE = "adam-shell-v16";   // v16: Checklists view added to the ADAM menu (new overlay + /checklists-view page in index.html). Bump forces a clean SW re-activate + refreshes the offline shell copy
...
self.addEventListener("fetch", (event) => {
  ...
  if (url.pathname === "/manifest.json" || url.pathname === "/icon.png" ||
      url.pathname === "/icon-maskable.png" || url.pathname === "/logo.png") {
    event.respondWith((async () => {
