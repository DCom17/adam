...
# READ-ONLY / PRINT-ONLY: it never changes Tailscale, Jarvis config, or anything else.
#
#   .\scripts\connect-phone.ps1                 # human-readable guidance
#   .\scripts\connect-phone.ps1 -Json           # machine-readable diagnostic (no secrets)
#   .\scripts\connect-phone.ps1 -Port 8443      # force the Jarvis HTTPS serve port
#   .\scripts\connect-phone.ps1 -TargetPort 8010 # override the local Jarvis port
